...
let currentSlide = 0;
let cartItems = [];
const slides = ['./pictures/hero1.jpg', './pictures/hero2.jpg',
    './pictures/hero3.jpg'
];
const products = [{
    id: 1,
